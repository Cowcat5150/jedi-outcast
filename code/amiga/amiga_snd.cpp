...
qboolean SNDDMA_Init(void)
{
	...
	sndspeed = Cvar_Get("sndspeed", "22050", CVAR_ARCHIVE); // was 22050 was 441000 - Cowcat
	...
	#ifdef __PPC__
	if ((dmabuf = (UBYTE *)AllocVecPPC(buflen, MEMF_ANY|MEMF_PUBLIC|MEMF_CLEAR, 0)) == NULL)
	#else
