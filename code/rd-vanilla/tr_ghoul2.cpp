...
public:
	...
	//mdxaSkel_t **mSkels; // not used - Cowcat
...
//				texCoords+=2;// Size of gore (s,t).
	...
	RB_CHECKOVERFLOW( surface->numVerts, surface->numTriangles * 3); // should be this ? - Cowcat
